...
router.register("vendor-refunds", VendorRefundViewSet, basename="vendor-refund")
router.register("vendor-debit-notes", VendorDebitNoteViewSet, basename="vendor-debit-note")
